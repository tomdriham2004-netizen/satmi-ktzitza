...
export const ROSTER = [
  ...
  { id: 'tina',   name: 'טינה טורבו',   color: '#FF4D5E', accent: '#FFFFFF', hat: 'goggles',   bio: 'לא בולמת לעולם. גם לא בשביל לשלם שכירות.' },
  { id: 'cap',    name: 'קפטן צדפה',    color: '#2FA8FF', accent: '#FFFFFF', hat: 'sailor',    bio: 'הגיע עם המעבורת. אף פעם לא עזב.' },
  { id: 'pepper', name: 'שף פלפל',      color: '#FF9A2E', accent: '#FFFFFF', hat: 'chef',      bio: 'מבשל טאקו. וגם את ספרי החשבונות.' },
